...
os.chdir(r"/home/evkikum/Desktop/Datascience/Python/Practice/NLP/NLP_basics/LayProgrammer")
...
word_index_map = {}  ## Empty dictionary
current_index = 0
positive_tokenized = []
negative_tokenized = []
orig_reviews = []
...
##NOW LETS CREATE OUR INPUT MATRICES
